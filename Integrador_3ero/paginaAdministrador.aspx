            ...
            <div class="main-content">
                ...
                <div id="usuarios" class="section" style="display: none;">
                    ...
                    <div class="form-container">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtCedula" runat="server" CssClass="text-input" Placeholder="Ingresa tu cedula de identidad" TextMode="Number"></asp:TextBox>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtContrasenia" runat="server" CssClass="text-input" Placeholder="Ingresa una contraseña" TextMode="Password"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <label for="txtContraseniaV">Verificar Contraseña:</label>
                            <asp:TextBox ID="txtContraseniaV" runat="server" CssClass="text-input" Placeholder="verifica tu contraseña" TextMode="Password"></asp:TextBox>
                        </div>
                    ...
                    <asp:GridView ID="gvUsuarios" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Acciones">
                                <ItemTemplate>
                                    <asp:Button ID="btnEditar_usuario" runat="server" Text="Editar" CommandName="Editar" CommandArgument='<%# Eval("usu_id") %>' CssClass="mi-boton" />
                ...
                <div id="Perfiles" class="section" style="display: none;">
                    ...
                    <div class="form-container">
                        ...
                        <div class="text-center mb-3">
                            <asp:Label ID="lbl_mensajeP" runat="server" CssClass="form-text" Text=""></asp:Label>
                        </div>
                        <asp:Button ID="btn_Agregar_Perfil" runat="server" Text="Enviar" CssClass="submit-button" OnClick="btn_Agregar_Perfil_Click" />
                    </div>
                    <asp:GridView ID="grvPerfiles" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Acciones">
                                <ItemTemplate>
                                    <asp:Button ID="btnEditarPerfil" runat="server" Text="Editar" CommandName="Editar" CommandArgument='<%# Eval("per_id") %>' CssClass="mi-boton" />
                                    <asp:Button ID="btnEliminarPerfil" runat="server" Text="Eliminar" CommandName="Eliminar" CommandArgument='<%# Eval("per_id") %>' CssClass="mi-boton-peligro" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
                ...
                <div id="Estado" class="section" style="display: none;">
                    ...
                    <div class="form-container">
                        ...
                        <asp:Button ID="btn_agregar_estado_usuario" runat="server" Text="Enviar" CssClass="submit-button" OnClick="btn_agregar_estado_usuario_Click" />
                    </div>
                    <asp:GridView ID="grvEstadosUsuarios" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Acciones">
                                <ItemTemplate>
                                    <asp:Button ID="btnEditarEstado" runat="server" Text="Editar" CommandName="Editar" CommandArgument='<%# Eval("est_id") %>' CssClass="mi-boton" />
                                    <asp:Button ID="btnEliminarEstado" runat="server" Text="Eliminar" CommandName="Eliminar" CommandArgument='<%# Eval("est_id") %>' CssClass="mi-boton-peligro" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
                ...
                <div id="TiposIncidencias" class="section" style="display: none;">
                    ...
                    <div class="form-container">
                        ...
                        <asp:Button ID="btn_agregar_tipo_incidencia" runat="server" Text="Enviar" CssClass="submit-button" OnClick="btn_agregar_tipo_incidencia_Click1" />
                        <div class="text-center mb-3">
                    ...
                    <asp:GridView ID="grvTipoIncidencia" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Acciones">
                                <ItemTemplate>
                                    <asp:Button ID="btnEditarTipoIncidencia" runat="server" Text="Editar" CommandName="Editar" CommandArgument='<%# Eval("tip_id") %>' CssClass="mi-boton" />
                                    <asp:Button ID="btnEliminarTipoIncidencia" runat="server" Text="Eliminar" CommandName="Eliminar" CommandArgument='<%# Eval("tip_id") %>' CssClass="mi-boton-peligro" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
                ...
                <div id="Equipos" class="section" style="display: none;">
                    ...
                    <div class="form-container">
                        ...
                        <asp:Button ID="btn_agregar_equipo" runat="server" Text="Enviar" CssClass="submit-button" OnClick="btn_agregar_equipo_Click" />
                    </div>
                    <asp:GridView ID="grvEquipos" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Acciones">
                                <ItemTemplate>
                                    <asp:Button ID="btnEditarEquipo" runat="server" Text="Editar" CommandName="Editar" CommandArgument='<%# Eval("equ_id") %>' CssClass="mi-boton" />
                                    <asp:Button ID="btnEliminarEquipo" runat="server" Text="Eliminar" CommandName="Eliminar" CommandArgument='<%# Eval("equ_id") %>' CssClass="mi-boton-peligro" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
                ...
                <div id="CategoriasInci" class="section" style="display: none;">
                    ...
                    <div class="form-container">
                        ...
                        <asp:Button ID="btn_agregar_catInci" runat="server" Text="Enviar" CssClass="submit-button" OnClick="btn_agregar_catInci_Click" />
                    </div>
                    <asp:GridView ID="grvCatInci" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Acciones">
                                <ItemTemplate>
                                    <asp:Button ID="btnEditarCatInci" runat="server" Text="Editar" CommandName="Editar" CommandArgument='<%# Eval("cat_id") %>' CssClass="mi-boton" />
                                    <asp:Button ID="btnEliminarCatInci" runat="server" Text="Eliminar" CommandName="Eliminar" CommandArgument='<%# Eval("cat_id") %>' CssClass="mi-boton-peligro" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
                ...
                <div id="EstadosInci" class="section" style="display: none;">
                    ...
                    <div class="form-container">
                        ...
                        <asp:Button ID="btn_agregar_estadoInci" runat="server" Text="Enviar" CssClass="submit-button" OnClick="btn_agregar_estadoInci_Click" />
                    </div>
                    <asp:GridView ID="grvEstInci" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Acciones">
                                <ItemTemplate>
                                    <asp:Button ID="btnEditarEstInci" runat="server" Text="Editar" CommandName="Editar" CommandArgument='<%# Eval("esi_id") %>' CssClass="mi-boton" />
                                    <asp:Button ID="btnEliminarEstInci" runat="server" Text="Eliminar" CommandName="Eliminar" CommandArgument='<%# Eval("esi_id") %>' CssClass="mi-boton-peligro" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
